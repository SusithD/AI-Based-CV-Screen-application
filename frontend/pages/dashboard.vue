  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div class="mb-8">
        <nav class="flex space-x-8">
          <button 
            ...
            :class="activeTab === 'overview' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700'"
          >
            Overview
          </button>
          <button 
            @click="activeTab = 'ats'"
            class="pb-2 text-sm font-medium border-b-2 transition-colors"
            :class="activeTab === 'ats' ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700'"
          >
            ATS Integrations
          </button>
          <button 
      ...
      <div v-if="activeTab === 'ats'">
        <ATSSettings :company-id="companyId" />
      </div>

      <!-- Settings Tab -->
      <div v-if="activeTab === 'settings'">
        <div class="bg-white border border-gray-100 rounded-lg p-6">
          <h2 class="text-lg font-medium text-gray-900 mb-4">Company Settings</h2>
          <p class="text-sm text-gray-600">Manage your company preferences and configurations.</p>
...
import ATSSettings from '~/components/ATSSettings.vue'

// Active tab state
const activeTab = ref('overview')

// Mock company ID - replace with actual company ID from auth
const companyId = ref('507f1f77bcf86cd799439011')
